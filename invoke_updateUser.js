...
async function main(argv) {
  ...
  try {
    ...
    const response = await contract.submitTransaction('updateUser', myArgs[0].toString(), myArgs[1].toString(), myArgs[2].toString(), myArgs[3].toString(), myArgs[4].toString(), myArgs[5].toString());
    // process response
